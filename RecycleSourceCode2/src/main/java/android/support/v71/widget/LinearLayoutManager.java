    ...
    android.support.v71.widget.helper.ItemTouchHelper.ViewDropHandler
{
     ...
     */
    private void recycleChildren(RecyclerView.Recycler recycler, int startIndex,
                                 int endIndex)
    {
    ...
    private View findFirstReferenceChild(RecyclerView.Recycler recycler,
                                         RecyclerView.State state)
    {
    ...
    private View findLastReferenceChild(RecyclerView.Recycler recycler,
                                        RecyclerView.State state)
    {
    ...
    {
        LogUtil.d(TAG, "supportsPredictiveItemAnimations = " + (mPendingSavedState ==
                  null && mLastStackFromEnd == mStackFromEnd));
