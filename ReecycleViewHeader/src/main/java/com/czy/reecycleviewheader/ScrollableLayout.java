...
public class ScrollableLayout extends LinearLayout
{
    ...
    public boolean dispatchTouchEvent(MotionEvent ev)
    {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mActivePointerId == INVALID_POINTER ||
                activePointerIndexUp == INVALID_POINTER) {
                break;
            }
        ...
        case MotionEvent.ACTION_CANCEL:
            ...
            if (mActivePointerId == INVALID_POINTER ||
                activePointerIndexCancel == INVALID_POINTER) {
                break;
            }
            ...
            if (mClickHeader && (totalXCancelDiff > mTouchSlop ||
                                 totalYCancelDiff > mTouchSlop)) {
                int action = ev.getAction();
                ev.setAction(MotionEvent.ACTION_CANCEL);
                boolean dd = super.dispatchTouchEvent(ev);
                ev.setAction(action);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        super.onMeasure(widthMeasureSpec,
                        MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec) + mMaxTouchY,
                                MeasureSpec.EXACTLY));
    }
