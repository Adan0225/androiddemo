...
public class CommentTopBarReturnTransition extends Transition
{
    ...
    private static final String PROPNAME_TRANSITION_Y =
        "custom_top_box_return_transition:change_transY:transitionY";
    ...
    {
        transitionValues.values.put(PROPNAME_TRANSITION_Y,
                                    -mContext.getResources().getDimensionPixelOffset(R.dimen.top_bar_height));
    }
