...
public class CustomAlertDialog extends AppCompatDialog
{
    ...
    public static class Builder
    {
        ...
        public CustomAlertDialog.Builder setPositiveButton(CharSequence text,
        ...
        public CustomAlertDialog.Builder setPositiveButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog.Builder setNegativeButton(CharSequence text,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog.Builder setNegativeButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog.Builder setNeutralButton(CharSequence text,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog.Builder setNeutralButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog.Builder setOnCancelListener(OnCancelListener
                onCancelListener)
        {
        ...
        public CustomAlertDialog.Builder setOnDismissListener(OnDismissListener
                onDismissListener)
        {
