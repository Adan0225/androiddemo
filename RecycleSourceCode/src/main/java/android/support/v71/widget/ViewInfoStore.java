...
import static
android.support.v71.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static
android.support.v71.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static
android.support.v71.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
import static
android.support.v71.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
...
class ViewInfoStore
{
     ...
     */
    @VisibleForTesting
    final ArrayMap<RecyclerView.ViewHolder, InfoRecord> mLayoutHolderMap = new
    ArrayMap<>();

    @VisibleForTesting
    final LongSparseArray<RecyclerView.ViewHolder> mOldChangedHolders = new
    LongSparseArray<>();
     ...
     */
    @Nullable
    RecyclerView.ItemAnimator.ItemHolderInfo popFromPreLayout(
     ...
     * @param info   The information to save
     */
    void addToAppearedInPreLayoutHolders(RecyclerView.ViewHolder holder,
                                         RecyclerView.ItemAnimator.ItemHolderInfo info)
    {
        InfoRecord record = mLayoutHolderMap.get(holder);
     ...
     * @param info   The information to save
     */
    void addToPostLayout(RecyclerView.ViewHolder holder,
                         RecyclerView.ItemAnimator.ItemHolderInfo info)
    {
        InfoRecord record = mLayoutHolderMap.get(holder);
    ...
    void process(ProcessCallback callback)
    {
        for (int index = mLayoutHolderMap.size() - 1; index >= 0; index--) {
            ...
            } else if ((record.flags & FLAG_APPEAR_PRE_AND_POST) ==
