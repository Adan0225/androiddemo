            ...
            final Intent data, final String dir)
    {
        ...
        if (cu != null && cu.getCount() > 0) {
            try {
                ...
                Log.e(TAG, "orition: " + cu.getString(cu.getColumnIndex(
            ...
            try {
                final String fileName = MD5.getMessageDigest(
                                            DateFormat.format("yyyy-MM-dd-HH-mm-ss",
                                                    System.currentTimeMillis()).toString().getBytes()) + Util.PHOTO_DEFAULT_EXT;
                filePath = dir + fileName;
