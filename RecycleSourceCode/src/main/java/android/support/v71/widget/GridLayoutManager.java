...
public class GridLayoutManager extends LinearLayoutManager
{
    ...
    public void onInitializeAccessibilityNodeInfoForItem(
        android.support.v71.widget.RecyclerView.Recycler recycler,
        android.support.v71.widget.RecyclerView.State state, View host,
        AccessibilityNodeInfoCompat info)
    {
        ...
        int spanGroupIndex = getSpanGroupIndex(recycler, state,
                                               glp.getViewLayoutPosition());
    ...
    @Override
    public void onItemsAdded(android.support.v71.widget.RecyclerView recyclerView,
    ...
    @Override
    public void onItemsChanged(android.support.v71.widget.RecyclerView
                               recyclerView)
    {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }
    ...
    @Override
    public void onItemsRemoved(android.support.v71.widget.RecyclerView recyclerView,
                               int positionStart, int itemCount)
    {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }
    ...
    @Override
    public void onItemsUpdated(android.support.v71.widget.RecyclerView recyclerView,
                               int positionStart, int itemCount,
                               Object payload)
    {
        mSpanSizeLookup.invalidateSpanIndexCache();
    ...
    @Override
    public void onItemsMoved(android.support.v71.widget.RecyclerView recyclerView,
    ...
    @Override
    public android.support.v71.widget.RecyclerView.LayoutParams
    ...
    public boolean checkLayoutParams(
        android.support.v71.widget.RecyclerView.LayoutParams lp)
    {
    ...
    private void calculateItemBorders(int totalSpace)
    {
        ...
        for (int i = 1; i <= mSpanCount; i++) {
            ...
            if (additionalSize > 0 &&
                (mSpanCount - additionalSize) < sizePerSpanRemainder) {
                itemSize += 1;
                            ...
                            int start, int end, int itemCount)
    {
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount) {
                ...
                if (((android.support.v71.widget.RecyclerView.LayoutParams)
                     view.getLayoutParams()).isItemRemoved()) {
    ...
    private int getSpanGroupIndex(android.support.v71.widget.RecyclerView.Recycler
                                  recycler, android.support.v71.widget.RecyclerView.State state,
                                  int viewPosition)
    {
        if (!state.isPreLayout()) {
        ...
        final int adapterPosition = recycler.convertPreLayoutPositionToPostLayout(
                                        viewPosition);
    ...
    private int getSpanIndex(android.support.v71.widget.RecyclerView.Recycler
                             recycler, android.support.v71.widget.RecyclerView.State state, int pos)
    {
        if (!state.isPreLayout()) {
    ...
    private int getSpanSize(android.support.v71.widget.RecyclerView.Recycler
                            recycler, android.support.v71.widget.RecyclerView.State state, int pos)
    {
        if (!state.isPreLayout()) {
                     ...
                     LayoutState layoutState, LayoutChunkResult result)
    {
        ...
        assignSpans(recycler, state, count, consumedSpanCount,
            ...
            boolean capBothSpecs)
    {
        ...
        android.support.v71.widget.RecyclerView.LayoutParams lp =
            (android.support.v71.widget.RecyclerView.LayoutParams) child.getLayoutParams();
    ...
    private void assignSpans(android.support.v71.widget.RecyclerView.Recycler
                             recycler, android.support.v71.widget.RecyclerView.State state, int count,
    ...
    public static class LayoutParams extends
        android.support.v71.widget.RecyclerView.LayoutParams
    {
        ...
        public LayoutParams(android.support.v71.widget.RecyclerView.LayoutParams
                            source)
        {
            super(source);
        }
