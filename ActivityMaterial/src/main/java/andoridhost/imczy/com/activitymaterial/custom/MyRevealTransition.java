...
public class MyRevealTransition extends Transition
{
    ...
    private static final String PROPNAME_BACKGROUND =
        "custom_reveal:change_radius:radius";
    ...
    public void captureStartValues(TransitionValues transitionValues)
    {
        transitionValues.values.put(PROPNAME_BACKGROUND,
                                    transitionValues.view.getWidth() / 2);
    }
                                   ...
                                   TransitionValues startValues, TransitionValues endValues)
    {
        ...
        if (view == animView) {
            Log.e(TAG, "createAnimator: startRadius = " + startRadius + " endRadius = " +
                  endRadius);
    ...
    private Animator createAnimator(View view, float startRadius, float endRadius)
    {
        ...
        Animator reveal = ViewAnimationUtils.createCircularReveal(view, centerX,
                          centerY,
    ...
    public static class AnimatorListenerWrapper implements
