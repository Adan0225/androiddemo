...
public class DrawView extends View
{
    ...
    private void refreshStartPoint()
    {
        ...
        LogUtil.d(TAG, "refreshStartPoint location = " + location[0] + "," + location[1]
                  + ", PhoneUtil.getStatusBarHeight(getContext()=" + PhoneUtil.getStatusBarHeight(
                      getContext()));
        ...
        LogUtil.d(TAG, "refreshStartPoint location = " + location[0] + "," +
                  location[1]);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (isTouched) {
            ...
            LogUtil.d(TAG, "onDraw isTouched startCircleX = " + startCircleX +
                      " , startCircleY = " + startCircleY);
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        case MotionEvent.ACTION_DOWN:
            isTouched = true;
            changeViewSize(this, ViewGroup.LayoutParams.MATCH_PARENT,
                           ViewGroup.LayoutParams.MATCH_PARENT);
            postInvalidate();
            lastDownX = initDownX = event.getX() + location[0];
            lastDownY = initDownY = event.getY() + location[1];
            LogUtil.d(TAG, "onTouchEvent initDownX = " + initDownX + " initDownY = " +
                      initDownY);
            break;
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            LogUtil.d(TAG, "onTouchEvent startPoint.x = " + startPoint.x +
