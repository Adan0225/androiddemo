...
public class MyAppBarLayout extends LinearLayout
{
    ...
    public static class Behavior extends HeaderBehavior<MyAppBarLayout>
    {
        ...
        public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout,
                                           MyAppBarLayout child, View directTargetChild, View target,
        ...
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
                                      MyAppBarLayout child, View target, int dx, int dy, int[] consumed)
        {
        ...
        public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout,
                                        MyAppBarLayout child, View target, float velocityX, float velocityY)
        {
            LogUtil.d(TAG, "onNestedPreFling");
            return super.onNestedPreFling(coordinatorLayout, child, target, velocityX,
                                          velocityY);
        }
        ...
        public void onNestedScroll(CoordinatorLayout coordinatorLayout,
                                   MyAppBarLayout child, View target, int dxConsumed, int dyConsumed,
        ...
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout,
                                       MyAppBarLayout child, View target)
        {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior
    {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs)
        {
            ...
            mOverlayTop = a.getDimensionPixelSize(
                              android.support.design.R.styleable.ScrollingViewBehavior_Params_behavior_overlapTop,
                              0);
            a.recycle();
        }
