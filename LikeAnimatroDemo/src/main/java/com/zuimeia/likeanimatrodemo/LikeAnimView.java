...
public class LikeAnimView extends View
{
    ...
    private static int LIKE_DRAWABLE_ANIM_START_DELAY_TIME =
        STROKE_INCREASE_ANIM_TIME + CIRCLE_RADIUS_INCREASE_ANIM_TIME * 8 / 9;
    ...
    {
        Log.e(TAG, "isAnimating: (alphaAnim != null && alphaAnim.isRunning() = " +
              (alphaAnim != null && alphaAnim.isRunning()));
        Log.e(TAG, "isAnimating: (alphaAnim != null && alphaAnim.isRunning() = " +
              (circleRadiusIncreaseAnim != null && circleRadiusIncreaseAnim.isRunning()));
        Log.e(TAG,
              "isAnimating: (strokeDecreaseAnim != null && strokeDecreaseAnim.isRunning())  = "
              + (strokeDecreaseAnim != null && strokeDecreaseAnim.isRunning()));
        Log.e(TAG,
              "isAnimating: (likeDrawableAnim != null && likeDrawableAnim.isRunning()) = "
              + ((likeDrawableAnim != null && likeDrawableAnim.isRunning())));
    ...
    public void startAnim()
    {
        ...
        strokeIncreaseAnim.addUpdateListener(new
        ...
        circleRadiusIncreaseAnim.addUpdateListener(new
        ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int val = (int) animation.getAnimatedValue();
        ...
        strokeDecreaseAnim.addUpdateListener(new
        ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int val = (int) animation.getAnimatedValue();
    ...
    public void startStickAnim(@STICK_DIRECTION final int direction)
    {
        ...
        ValueAnimator bottomIncreaseAnim = ValueAnimator.ofInt(initIncreaseVal,
                                           firstBottom);
        bottomIncreaseAnim.addUpdateListener(new
        ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int val = (int) animation.getAnimatedValue();
        ...
        if (direction == DIRECTION_TOP) {
            ...
            bottomDecreaseAnim = ValueAnimator.ofInt(mMinSize - (firstBottom + transY),
                                 mMinSize - firstTop);
        } else if (direction == DIRECTION_BOTTOM) {
            bottomDecreaseAnim = ValueAnimator.ofInt(mMinSize - (firstBottom + transY),
                                 mMinSize - firstTop);
        ...
        bottomDecreaseAnim.addUpdateListener(new
        ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int val = (int) animation.getAnimatedValue();
        ...
        bottomDecreaseAnim.setStartDelay(RECT_TRANS_ANIM_TIME +
                                         RECT_INCREASE_ANIM_TIME);
    ...
    private void startStickAlphaAnim()
    {
        ...
        alphaAnim.setStartDelay(RECT_TRANS_ANIM_TIME + RECT_INCREASE_ANIM_TIME +
                                RECT_DECREASE_ANIM_TIME);
