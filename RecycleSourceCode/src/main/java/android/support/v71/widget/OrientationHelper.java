...
public abstract class OrientationHelper
{
    ...
    protected final android.support.v71.widget.RecyclerView.LayoutManager
    mLayoutManager;
    ...
    private OrientationHelper(android.support.v71.widget.RecyclerView.LayoutManager
                              layoutManager)
    {
        ...
        android.support.v71.widget.RecyclerView.LayoutManager layoutManager)
    {
        return new OrientationHelper(layoutManager) {
            ...
            public int getDecoratedMeasurement(View view) {
                final android.support.v71.widget.RecyclerView.LayoutParams params =
