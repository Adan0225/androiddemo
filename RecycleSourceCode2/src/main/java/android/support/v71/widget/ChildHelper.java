...
class ChildHelper
{
     ...
     */
    void attachViewToParent(View child, int index,
    ...
    void hide(View view)
    {
        ...
        if (DEBUG && mBucket.get(offset)) {
            throw new RuntimeException("trying to hide same view twice, how come ? " +
                                       view);
        }
    ...
    void unhide(View view)
    {
        ...
        if (!mBucket.get(offset)) {
            throw new RuntimeException("trying to unhide a view that was not hidden" +
                                       view);
        }
