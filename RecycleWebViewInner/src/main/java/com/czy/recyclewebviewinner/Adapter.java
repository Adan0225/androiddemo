...
public class Adapter extends RecyclerView.Adapter
{
    ...
    {
        if (viewType == 0) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.recycle_item, parent,
                        false);
            ...
            View view = LayoutInflater.from(mContext).inflate(R.layout.recycle_web_viewitem,
                        parent, false);
