...
public class CommentBottomBarEnterTransition extends Transition
{
    ...
    private static final String PROPNAME_BOTTOM_BOX_TRANSITION_Y =
        "custom_bottom_box_enter_transition:change_transY:transitionY";
    private static final String PROPNAME_TOP_BAR_TRANSITION_Y =
        "custom_top_bar_transition:change_transY:transitionY";
                                   ...
                                   TransitionValues startValues, TransitionValues endValues)
    {
        ...
        if (view == animView) {
            ...
            int startTransY = (int) startValues.values.get(
                                  PROPNAME_BOTTOM_BOX_TRANSITION_Y);
            int endTransY = (int) endValues.values.get(PROPNAME_BOTTOM_BOX_TRANSITION_Y);

            Log.d(TAG, "createAnimator: view == animView startTransY = " + startTransY +
                  " , endTransY = " + endTransY);
