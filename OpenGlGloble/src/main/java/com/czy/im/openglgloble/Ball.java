...
public class Ball
{
    ...
    public Ball(int scale, int textureId)
    {
        ...
        ArrayList<Integer> alVertix = new
        ArrayList<Integer>();// ��Ŷ�������ArrayList
        ...
        // ����������껺��
        float textureCoors[] = new
        float[alTexture.size()];// ��������ֵ����
    ...
    public void drawSelf(GL10 gl)
    {
        ...
        ((GL11) gl).glGetFloatv(GL11.GL_MODELVIEW_MATRIX, modelview,
                                0); // ��ȡ��ǰ����
        float[] x_axis = { 1, 0, 0, 0 };
        float[] y_axis = { 0, 1, 0, 0 };
        Matrix.invertM(modelview, 0, modelview, 0); // �������
        Matrix.multiplyMV(x_axis, 0, modelview, 0, x_axis,
                          0); // ��ȡ����x����ģ�����ϵ���ָ��w�ᣩ
