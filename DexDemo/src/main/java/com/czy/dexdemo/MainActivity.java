...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final String themeApkPath = IOUtil.getBaseLocalLocation(
                                        this) + File.separator + "ThemeDemo.apk";
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClassLoader classLoader = new DexClassLoader(themeApkPath, optimizedDirectory,
                        null, getClassLoader());
