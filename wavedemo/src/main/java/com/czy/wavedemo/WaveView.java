...
public class WaveView extends View
{
    ...
    private void init()
    {
        ...
        mXOffsetSpeedOne = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                           TRANSLATE_X_SPEED_ONE, getResources().getDisplayMetrics());
        mXOffsetSpeedTwo = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                           TRANSLATE_X_SPEED_TWO, getResources().getDisplayMetrics());
