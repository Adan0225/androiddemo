...
public class PhoneUtil
{
    ...
    public static int getDisplayVisibleHeight(Context context)
    {
        ...
        WindowManager wm = (WindowManager) context.getSystemService(
                               Context.WINDOW_SERVICE);
        wm.getDefaultDisplay().getMetrics(dm);
        Drawable phoneCallIcon = context.getResources().getDrawable(
    ...
    {
        return 1024 * 1024 * ((ActivityManager) context.getSystemService(
    ...
    public static int getRawSize(Context context, int unit, float size)
    {
        ...
        return (int) TypedValue.applyDimension(unit, size,
        ...
        try {
            ...
            if (info != null && info.isAvailable()) {
                ...
                if (typeName.equals("wifi")) {
                    ...
                    typeName =
                        info.getExtraInfo().toLowerCase(); // 3gnet/3gwap/uninet/uniwap/cmnet/cmwap/ctnet/ctwap
                }
