...
public class ScrollableLinearLayout extends RelativeLayout
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(height + mMaxScrollDistance,
                            MeasureSpec.EXACTLY);
    ...
    public void computeScroll()
    {
        ...
        if (mUpFlingScroller.computeScrollOffset()) {
            LogUtil.e(TAG, "mUpFlingScroller mOnScrollListener.canScrollUp() = " +
                      mOnScrollListener.canScrollUp());

            // fling 的
            if (!mOnScrollListener.canScrollUp()) {
                LogUtil.d(TAG, " computeScroll mOnScrollListener.canScrollUp() = " +
                          mOnScrollListener.canScrollUp() + "滑动 ListView");
        ...
        if (mDownFlingScroller.computeScrollOffset()) {
            LogUtil.e(TAG, "mDownFlingScroller mOnScrollListener.canScrollUp() = " +
                      mOnScrollListener.canScrollUp());
    ...
    public boolean dispatchTouchEvent(MotionEvent ev)
    {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if (mIsVerticalScroll) {
                if (!mIsBeingExpand) {
                    if ((mIsUp && mOnScrollListener.canScrollUp()) || (!mIsUp &&
                            mOnScrollListener.canScrollDown())) {
                        mIsBeingExpand = true;
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mVelocityTracker != null) {
                ...
                velocityTracker.computeCurrentVelocity(1000,
                                                       mMaximumVelocity);// SUPPRESS CHECKSTYLE
            ...
            if (mIsVerticalScroll) {
                if (Math.abs(yVelocity) > mMinimumVelocity) {
                    ...
                    if (velocity > 0) {
                        ...
                        mDownFlingScroller.forceFinished(true);
                        mHeadScroller.forceFinished(true);
                        mUpFlingScroller.fling(0, 0, 0, velocity, 0, Integer.MAX_VALUE, 0,
                                               Integer.MAX_VALUE);
                        ...
                        mUpFlingScroller.forceFinished(true);
                        mDownFlingScroller.fling(0, 0, 0, -velocity, 0, Integer.MAX_VALUE, 0,
                                                 Integer.MAX_VALUE);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev)
    {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            LogUtil.d(TAG, "onInterceptTouchEvent mRect = " + mRect + " x = " + ev.getRawX()
                      + " y = " + ev.getRawY());
        ...
        case MotionEvent.ACTION_MOVE:
            LogUtil.d(TAG, "onInterceptTouchEvent mIsVerticalScroll = " + mIsVerticalScroll
                      + " , isDownInListView = " + isDownInListView + " , mIsBeingExpand = " +
                      mIsBeingExpand);
