...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getWindow().getSharedElementReturnTransition().addListener(
        new Transition.TransitionListener() {
            @Override
            public void onTransitionStart(Transition transition) {
                Log.d(TAG, "getSharedElementReturnTransition onTransitionStart() called with: "
        ...
        new Transition.TransitionListener() {
            @Override
            public void onTransitionStart(Transition transition) {
                Log.d(TAG, "getSharedElementExitTransition onTransitionStart() called with: " +
                      "transition = [" + transition + "]");
            }
        ...
        getWindow().getSharedElementReenterTransition().addListener(
        new Transition.TransitionListener() {
            @Override
            public void onTransitionStart(Transition transition) {
                Log.d(TAG, "getSharedElementReenterTransition onTransitionStart() called with: "
                      + "transition = [" + transition + "]");
