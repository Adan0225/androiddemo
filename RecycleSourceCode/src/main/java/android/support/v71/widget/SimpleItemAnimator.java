    ...
    SimpleItemAnimator extends android.support.v71.widget.RecyclerView.ItemAnimator
{
                                        ...
                                        @NonNull ItemHolderInfo preLayoutInfo, @Nullable ItemHolderInfo postLayoutInfo)
    {
        ...
        int newLeft = postLayoutInfo == null ? disappearingItemView.getLeft() :
                      postLayoutInfo.left;
        int newTop = postLayoutInfo == null ? disappearingItemView.getTop() :
                     postLayoutInfo.top;
        ...
        if (!viewHolder.isRemoved() && (oldLeft != newLeft || oldTop != newTop)) {
            ...
            if (DEBUG) {
                Log.d(TAG, "DISAPPEARING: " + viewHolder + " with view " +
