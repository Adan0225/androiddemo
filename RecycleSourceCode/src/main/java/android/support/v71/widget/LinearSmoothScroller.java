...
abstract public class LinearSmoothScroller extends RecyclerView.SmoothScroller
{
    ...
    protected final LinearInterpolator mLinearInterpolator = new
    LinearInterpolator();

    protected final DecelerateInterpolator mDecelerateInterpolator = new
    ...
    {
        MILLISECONDS_PER_PX = calculateSpeedPerPixel(
