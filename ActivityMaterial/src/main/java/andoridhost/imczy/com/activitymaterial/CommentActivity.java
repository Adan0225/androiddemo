...
public class CommentActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getWindow().setEnterTransition(new CommentEnterTransition(this, topBarView,
                                       bottomSendView));
        getWindow().setReturnTransition(new CommentReturnTransition(this, topBarView,
                                        bottomSendView));
        ...
        ChangeColor changeColor = new ChangeColor(getResources().getColor(
                    R.color.black_85_alpha), getResources().getColor(R.color.white));
    ...
    private TransitionSet buildReturnSet()
    {
        ...
        ChangeColor changeColor = new ChangeColor(getResources().getColor(
                    R.color.white), getResources().getColor(R.color.black_85_alpha));
        changeColor.addTarget(R.id.comment_box);
