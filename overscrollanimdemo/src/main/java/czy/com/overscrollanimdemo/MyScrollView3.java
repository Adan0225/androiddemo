...
public class MyScrollView3 extends FrameLayout
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (getChildCount() > 0) {
            ...
            if (targetSdkVersion >= Build.VERSION_CODES.M) {
                widthPadding = getPaddingLeft() + getPaddingRight() + lp.leftMargin +
                               lp.rightMargin;
                heightPadding = getPaddingTop() + getPaddingBottom() + lp.topMargin +
                                lp.bottomMargin;
            } else {
                                ...
                                int parentHeightMeasureSpec)
    {
        ...
        Log.e(TAG, "measureChild: childWidthMeasureSpec = " + Math.max(0,
                MeasureSpec.getSize(parentWidthMeasureSpec) - horizontalPadding));
        child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
    ...
    {
        Log.d(TAG, "measureChildWithMargins() called with: child = [" + child +
              "], parentWidthMeasureSpec = [" + parentWidthMeasureSpec + "], widthUsed = [" +
              widthUsed + "], parentHeightMeasureSpec = [" + parentHeightMeasureSpec +
        ...
        final int usedTotal = getPaddingLeft() + getPaddingRight() + lp.leftMargin +
                              lp.rightMargin +
                              widthUsed;
        final int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        final int available = r - l - getPaddingLeft() - getPaddingRight() -
                              childMargins;
    ...
    {
        Log.d(TAG, "computeScroll() calle dmScroller.computeScrollOffset() = " +
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            Log.e(TAG, "computeScroll: oldX = " + oldX + " , oldY = " + oldY + " , x = " + x
                  + " , y = " + y);
            ...
            if (oldX != x || oldY != y) {
                ...
                overScrollBy(x - oldX, y - oldY, oldX, oldY, range, 0, mOverflingDistance, 0,
                             false);
    ...
    public boolean onTouchEvent(MotionEvent ev)
    {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if (mIsBeingDragged) {
                ...
                Log.d(TAG, "onTouchEvent: overScrollBy deltaX = " + deltaX +
                      " ,  getScrollX() = " + getScrollX() + " range = " + range +
                                  ...
                                  boolean clampedX, boolean clampedY)
    {
        ...
        Log.d(TAG, "onOverScrolled() called with: scrollX = [" + scrollX +
              "], scrollY = [" + scrollY + "], clampedX = [" + clampedX + "], clampedY = [" +
              clampedY + "]" + " , mScroller.isFinished() = " + mScroller.isFinished());
    ...
    public void fling(int velocityX)
    {
        ...
        if (getChildCount() > 0) {
            ...
            mScroller.fling(getScrollX(), getScrollY(), velocityX, 0, 0, Math.max(0,
                            right - width), 0, 0, width / 2, 0);
