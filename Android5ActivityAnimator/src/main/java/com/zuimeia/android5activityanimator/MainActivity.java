    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mBlackBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                path.lineTo(1f, 1f);
                PathInterpolator pathInterpolator = new PathInterpolator(0.27f, 2.34f, 0.49f,
                        -0.91f);
                mAnimator = ObjectAnimator.ofFloat(mBlackBox, View.TRANSLATION_Y,
                                                   mBlackBox.getTranslationY(), 200);
