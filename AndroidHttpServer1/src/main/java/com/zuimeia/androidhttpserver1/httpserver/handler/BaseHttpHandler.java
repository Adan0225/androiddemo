           ...
           ContentType
{
    ...
    private void doHandleFileUpload(CoreHttpRequest tzRequest,
                                    CoreHttpResponse tzResponse, HttpEntity entity)
    {
        try {
            ...
            if (boundaryIndex >= 0) {
                ...
                while (hasNextPart) {
                    ...
                    boolean isFileUpload = headerInfo != null &&
                                           headerInfo.indexOf("filename=") != -1 ;
