...
class ItemTouchUIUtilImpl
{
    static class Lollipop extends Honeycomb
    {
        ...
        public void onDraw(Canvas c,
                           android.support.v71.widget.RecyclerView recyclerView, View view,
        ...
        private float findMaxElevation(android.support.v71.widget.RecyclerView
    ...
    static class Honeycomb implements ItemTouchUIUtil
    {
        ...
        public void onDrawOver(Canvas c,
                               android.support.v71.widget.RecyclerView recyclerView,
    ...
    static class Gingerbread implements ItemTouchUIUtil
    {
        ...
        private void draw(Canvas c, android.support.v71.widget.RecyclerView parent,
                          View view,
                          float dX, float dY)
        {
            c.save();
