...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mCustomScrollViewGroup = (CustomScrollViewGroup) findViewById(
                                     R.id.customscrollviewgroup);

        maxTranY = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 300,
        ...
        mCustomScrollViewGroup.setOnScrollListener(new
        CustomScrollViewGroup.OnScrollListener() {
            /**
             * 滑动 的箭头
            ...
            public void onScroll(float distanceX, float distanceY) {
                ...
                LogUtil.d(TAG, "onScroll distanceX = " + distanceX + " , distanceY = " +
                          distanceY + ", currentTransY = " + currentTransY);
            }
    ...
    {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mView, "TranslationY",
                                        mView.getTranslationY(), -maxTranY);
