...
public class CustomAlertDialog2 extends AppCompatDialog
{
    ...
    public static class Builder
    {
        ...
        public CustomAlertDialog2.Builder setPositiveButton(CharSequence text,
        ...
        public CustomAlertDialog2.Builder setPositiveButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog2.Builder setNegativeButton(CharSequence text,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog2.Builder setNegativeButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog2.Builder setNeutralButton(CharSequence text,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog2.Builder setNeutralButton(int textId,
                final View.OnClickListener listener)
        {
        ...
        public CustomAlertDialog2.Builder setOnCancelListener(OnCancelListener
                onCancelListener)
        {
        ...
        public CustomAlertDialog2.Builder setOnDismissListener(OnDismissListener
                onDismissListener)
        {
