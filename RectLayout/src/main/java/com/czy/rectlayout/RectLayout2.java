...
public class RectLayout2 extends RelativeLayout
{
    ...
    private void init(AttributeSet attrs)
    {
        ...
        txtColor = typedArray.getColor(R.styleable.RectLayout_txtColor,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        mBgBorderRect.set(txtHeight / 2, txtHeight / 2, r - l - txtHeight / 2,
                          b - t - txtHeight / 2);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        mTopCleanRect.set(topCleanRectLeft, topCleanRectTop, topCleanRectRight,
                          topCleanRectBottom);
        ...
        mBottomCleanRect.set(bottomCleanRectLeft, bottomCleanRectTop,
                             bottomCleanRectRight, bottomCleanRectBottom);
        ...
        mBottomTxtRect.set(bottomTxtLeft, bottomTxtTop, bottomTxtRight,
                           bottomTxtBottom);
        ...
        int topBaseline = (mTopTxtRect.bottom + mTopTxtRect.top - fontMetrics.bottom -
                           fontMetrics.top) / 2;
        canvas.drawText(mTopTxt, mTopTxtRect.centerX(), topBaseline, mTxtPaint);

        int bottomBaseline = (mBottomTxtRect.bottom + mBottomTxtRect.top -
                              fontMetrics.bottom - fontMetrics.top) / 2;
        canvas.drawText(mBottomTxt, mBottomTxtRect.centerX(), bottomBaseline,
                        mTxtPaint);
