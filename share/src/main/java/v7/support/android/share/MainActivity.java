...
public class MainActivity extends AppCompatActivity
{
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    ShareUtil.shareLink(getContext(), ShareUtil.SHARE_WAY_FACEBOOK,
                                        "asdasd https://www.baidu.com/");
                }
            }
        });
    }
    ...
    {
        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.setClassName("com.facebook.orca",
    ...
    {
        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.setClassName("com.snapchat.android",
    ...
    {
        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.setClassName("com.imo.android.imoim",
                            "com.imo.android.imoim.activities.SharingActivity");
        intent.putExtra(Intent.EXTRA_TEXT, content);
        intent.setType("text/plain");
        intent.addCategory(Intent.CATEGORY_DEFAULT);
        startActivity(intent);
    ...
    {
        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.setClassName("com.google.android.apps.messaging",
