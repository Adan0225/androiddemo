...
public class RectLayout extends RelativeLayout
{
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        mBorderRect.set(mTextHeight / 2, mTextHeight / 2, r - l - mTextHeight / 2,
                        b - t - mTextHeight / 2);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        int baseline = (textRect.bottom + textRect.top - fontMetrics.bottom -
                        fontMetrics.top) / 2;
        // 水平居中
    ...
    public void setTitle(String title)
    {
        ...
        LogUtil.d(TAG, "mTextHeight = " + mTextHeight + " , mTextWidth = " +
                  mTextWidth);
    }
