...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (mWebView.getX5WebViewExtension() != null) {
            ...
            data.putBoolean("standardFullScreen",
                            false);//true表示标准全屏，false表示X5全屏；不设置默认false，

            data.putBoolean("supportLiteWnd",
                            true);//false：关闭小窗；true：开启小窗；不设置默认true，

            data.putInt("DefaultVideoScreen",
                        2);//1：以页面内开始播放，2：以全屏开始播放；不设置默认：1
    ...
    private com.tencent.smtt.sdk.WebChromeClient chromeClient = new
    com.tencent.smtt.sdk.WebChromeClient()
    {

        @Override
        public boolean onJsConfirm(com.tencent.smtt.sdk.WebView arg0, String arg1,
                                   String arg2, JsResult arg3) {
            Log.d(TAG, "onJsConfirm() called with: arg0 = [" + arg0 + "], arg1 = [" + arg1 +
                  "], arg2 = [" + arg2 + "], arg3 = [" + arg3 + "]");
        ...
        public void onShowCustomView(View view,
            ...
            Log.d(TAG, "onShowCustomView() called with: view = [" + view +
        ...
        @Override
        public boolean onJsAlert(com.tencent.smtt.sdk.WebView arg0, String arg1,
                                 String arg2, JsResult arg3) {
            Log.d(TAG, "onJsAlert() called with: arg0 = [" + arg0 + "], arg1 = [" + arg1 +
                  "], arg2 = [" + arg2 + "], arg3 = [" + arg3 + "]");
            /**
         ...
         */
        @Override
        public boolean onJsPrompt(com.tencent.smtt.sdk.WebView arg0, String arg1,
                                  String arg2, String arg3, JsPromptResult arg4) {
            Log.d(TAG, "onJsPrompt() called with: arg0 = [" + arg0 + "], arg1 = [" + arg1 +
        ...
        @Override
        public void onReceivedTitle(com.tencent.smtt.sdk.WebView arg0,
                                    final String arg1) {
            super.onReceivedTitle(arg0, arg1);
            Log.d(TAG, "onReceivedTitle() called with: arg0 = [" + arg0 + "], arg1 = [" +
                  arg1 + "]");
