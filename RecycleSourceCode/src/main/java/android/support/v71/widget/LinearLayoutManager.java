...
public class LinearLayoutManager extends
    android.support.v71.widget.RecyclerView.LayoutManager implements
    android.support.v71.widget.helper.ItemTouchHelper.ViewDropHandler
{
    ...
    @Override
    public void onDetachedFromWindow(android.support.v71.widget.RecyclerView view,
                                     android.support.v71.widget.RecyclerView.Recycler recycler)
    {
     ...
     */
    protected int getExtraLayoutSpace(android.support.v71.widget.RecyclerView.State
                                      state)
    {
    ...
    @Override
    public void smoothScrollToPosition(android.support.v71.widget.RecyclerView
                                       recyclerView, android.support.v71.widget.RecyclerView.State state,
                                       int position)
    {
    ...
    public PointF computeScrollVectorForPosition(int targetPosition)
    {
        ...
        final int direction = targetPosition < firstChildPos != mShouldReverseLayout ?
                              -1 : 1;
     ...
     */
    @Override
    public void onLayoutChildren(android.support.v71.widget.RecyclerView.Recycler
                                 recycler, android.support.v71.widget.RecyclerView.State state)
    {
        // layout algorithm:
     ...
     */
    void onAnchorReady(android.support.v71.widget.RecyclerView.Recycler recycler,
    ...
    private void layoutForPredictiveAnimations(
        android.support.v71.widget.RecyclerView.Recycler recycler,
        android.support.v71.widget.RecyclerView.State state, int startOffset,
        int endOffset)
    {
        ...
        final List<android.support.v71.widget.RecyclerView.ViewHolder> scrapList =
     ...
     */
    private int fixLayoutEndGap(int endOffset,
                                android.support.v71.widget.RecyclerView.Recycler recycler,
    ...
    private void updateLayoutStateToFillEnd(int itemPosition, int offset)
    {
        ...
        mLayoutState.mItemDirection = mShouldReverseLayout ?
    ...
    private int computeScrollOffset(android.support.v71.widget.RecyclerView.State
                                    state)
    {
        if (getChildCount() == 0) {
            return 0;
        ...
        ensureLayoutState();
        return android.support.v71.widget.ScrollbarHelper.computeScrollOffset(state,
                mOrientationHelper,
    ...
    private int computeScrollExtent(android.support.v71.widget.RecyclerView.State
                                    state)
    {
        if (getChildCount() == 0) {
            return 0;
        ...
        ensureLayoutState();
        return android.support.v71.widget.ScrollbarHelper.computeScrollExtent(state,
                mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(android.support.v71.widget.RecyclerView.State
                                   state)
    {
        if (getChildCount() == 0) {
            return 0;
        ...
        ensureLayoutState();
        return android.support.v71.widget.ScrollbarHelper.computeScrollRange(state,
                mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    ...
    int scrollBy(int dy, android.support.v71.widget.RecyclerView.Recycler recycler,
                 android.support.v71.widget.RecyclerView.State state)
    {
     ...
     */
    private void recycleChildren(android.support.v71.widget.RecyclerView.Recycler
                                 recycler, int startIndex, int endIndex)
    {
    ...
    private void recycleViewsFromStart(
        android.support.v71.widget.RecyclerView.Recycler recycler, int dt)
    {
        if (dt < 0) {
            if (DEBUG) {
     ...
     */
    int fill(android.support.v71.widget.RecyclerView.Recycler recycler,
             LayoutState layoutState,
    ...
    void layoutChunk(android.support.v71.widget.RecyclerView.Recycler recycler,
                     android.support.v71.widget.RecyclerView.State state,
    ...
    private View findFirstReferenceChild(
        ...
        android.support.v71.widget.RecyclerView.State state)
    {
        return findReferenceChild(recycler, state, 0, getChildCount(),
                                  state.getItemCount());
    }
    ...
    private View findLastReferenceChild(
        ...
        android.support.v71.widget.RecyclerView.State state)
    {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1,
                                  state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(android.support.v71.widget.RecyclerView.Recycler
                            recycler, android.support.v71.widget.RecyclerView.State state,
    ...
    class AnchorInfo
    {
        ...
        private boolean isViewValidAsAnchor(View child,
                                            android.support.v71.widget.RecyclerView.State state)
        {
