...
public class TypefaceUtil
{
    ...
    private static final Map<String, Typeface> cache = new
    ...
    public static Typeface getTypeface(Context c, String path,
                                       String targetPackage)
    {
        Context targetContext = null;

        if (TextUtils.isEmpty(targetPackage) ||
            c.getPackageName().equals(targetPackage)) {
            targetContext = c;
        } else {
            try {
                targetContext = c.createPackageContext(targetPackage,
