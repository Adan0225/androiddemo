...
class MessageThreadUtil<T> implements ThreadUtil<T>
{
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T>
            callback)
    {
        return new MainThreadCallback<T>() {
            ...
            public void updateItemCount(int generation, int itemCount) {
                sendMessage(SyncQueueItem.obtainMessage(UPDATE_ITEM_COUNT, generation,
                                                        itemCount));
            }

            @Override
            public void addTile(int generation,
                                android.support.v71.util.TileList.Tile<T> tile) {
                ...
                public void run() {
                    ...
                    while (msg != null) {
                        ...
                        case ADD_TILE:
                            ...
                            callback.addTile(msg.arg1,
                                             (android.support.v71.util.TileList.Tile<T>) msg.data);
                            break;
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T>
            callback)
    {
        return new BackgroundCallback<T>() {
            ...
            public void refresh(int generation) {
                sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(REFRESH, generation,
                                          null));
            }
    ...
    static class SyncQueueItem
    {
        ...
        static SyncQueueItem obtainMessage(int what, int arg1, int arg2, int arg3,
                                           int arg4,
