...
public class TuziHttpServer extends Thread
{
    ...
    private Map<String, HttpRequestHandler> handlerMap = new
    ConcurrentHashMap<String, HttpRequestHandler>();

    public StartCompleteListener startCompleteListener;


    public void setStartCompleteListener(StartCompleteListener
                                         startCompleteListener)
    {
    ...
    public void run()
    {
        ...
        try {
            ...
            if (startCompleteListener != null) {
                startCompleteListener.getSocketInfo(server.getInetAddress() + "",
                                                    server.getLocalPort() + "");
            }
