...
public class MyChangeImageTransform extends Transition
{
    ...
    private static final String PROPNAME_TRANSLATION_X =
        "android:changeImageTransform:transX";
    private static final String PROPNAME_TRANSLATION_Y =
        "android:changeImageTransform:transY";
                               ...
                               boolean isStarted)
    {
        ...
        LogUtil.d(TAG, "captureValues , view = " + view +
        ...
        if (isStarted) {
            ...
            int screenHeight = PhoneUtil.getDisplayHeight(mContext) -
                               PhoneUtil.getStatusBarHeight();
            ...
            LogUtil.d(TAG, "rect = " + rect + " , screenWidth = " +
                      PhoneUtil.getScreentHeight(mContext) + " , screenHeight = " + screenHeight +
                                   ...
                                   TransitionValues startValues, TransitionValues endValues)
    {
        ...
        Animator mObjectAnimator1 = ObjectAnimator.ofFloat(view, "translationX",
                                    startTranx, endTranx);
        Animator mObjectAnimator2 = ObjectAnimator.ofFloat(view, "translationY",
                                    startTranY, endTranY);
