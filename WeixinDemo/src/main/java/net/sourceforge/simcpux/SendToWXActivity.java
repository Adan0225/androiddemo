    ...
    private void initView()
    {
        ...
        findViewById(R.id.send_text).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MMAlert.showAlert(SendToWXActivity.this, "send text", editor,
                                  getString(R.string.app_share), getString(R.string.app_cancel),
                    ...
                    public void onClick(int whichButton) {
                        ...
                        case MMAlertSelect2: {
                                ...
                                if (!file.exists()) {
                                    ...
                                    Toast.makeText(SendToWXActivity.this, tip + " path = " + path,
                        ...
                        case MMAlertSelect3: {
                                String url =
                                    "http://weixin.qq.com/zh_CN/htmledition/images/weixin/weixin_logo0d1938.png";
                ...
                null, new MMAlert.OnAlertSelectId() {
                    ...
                    public void onClick(int whichButton) {
                        ...
                        case MMAlertSelect1: {
                                ...
                                msg.title =
                                    "Video Title Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long";
                                msg.description =
                                    "Video Description Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long Very Long";
                                Bitmap thumb = BitmapFactory.decodeResource(getResources(),
                                               R.drawable.send_music_thumb);
                                msg.thumbData = Util.bmpToByteArray(thumb, true);
                ...
                null, new MMAlert.OnAlertSelectId() {
                    ...
                    public void onClick(int whichButton) {
                        ...
                        case MMAlertSelect2: {
                                ...
                                msg.description =
                                    "this is description sjgksgj sklgjl sjgsgskl gslgj sklgj sjglsjgs kl gjksss ssssssss sjskgs kgjsj jskgjs kjgk sgjsk Very Long Very Long Very Long Very Longgj skjgks kgsk lgskg jslgj";
                ...
                null, new MMAlert.OnAlertSelectId() {
                    ...
                    public void onClick(int whichButton) {
                        ...
                        case MMAlertSelect1: {
                                ...
                                msg.thumbData = Util.readFromFile(EMOJI_FILE_THUMB_PATH, 0,
                                                                  (int) new File(EMOJI_FILE_THUMB_PATH).length());
                        ...
                        case MMAlertSelect2: {
                                WXEmojiObject emoji = new WXEmojiObject();
                                emoji.emojiData = Util.readFromFile(EMOJI_FILE_PATH, 0,
                                                                    (int) new File(EMOJI_FILE_PATH).length());
                                WXMediaMessage msg = new WXMediaMessage(emoji);
