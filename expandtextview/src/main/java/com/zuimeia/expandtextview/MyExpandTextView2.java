...
public class MyExpandTextView2 extends TextView implements View.OnClickListener
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (!mHaveGetLineCount) {
            ...
            LogUtil.e(TAG, "onMeasure mLineCount = " + mLineCount +
                      " , mMaxCollapsedLines = " + mMaxCollapsedLines);
            ...
            post(new Runnable() {
                ...
                public void run() {
                    mIsNeedExpand = true;
                    mExpandDrawable.setBounds(0, 0, 0,
                                              mExpandDrawable.getMinimumHeight() + mExpandDrawablePadding * 2);
