...
public class MainActivity extends AppCompatActivity implements
    UDPClient.OnReceiverMessageListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try {
            mUDPClient = new UDPClient(DanmakuUtil.asBytes(SettingUtils.getDanmukuUuid()),
                                       1, Constant.DANMAKU_SERVER_HOSTNAME, Constant.DANMAKU_SERVER_PORT, this);
        } catch (Exception e) {
            e.printStackTrace();
        }
