...
public class DraggableFlagView extends View
{
    ...
    public void setOnDraggableFlagViewListener(OnDraggableFlagViewListener
    ...
    private boolean
    isArrivedMaxMoved; // 达到了最大的拉长距离（松手可以触发事件）
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            changeViewHeight(this, ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            triangle.deltaY = -1 * (event.getY() -
                                    downY); // y轴方向相反，所有需要取反
            double distance = Math.sqrt(triangle.deltaX * triangle.deltaX +
                                        triangle.deltaY * triangle.deltaY);
