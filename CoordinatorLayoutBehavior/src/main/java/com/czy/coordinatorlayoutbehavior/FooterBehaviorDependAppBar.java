 ...
 */
public class FooterBehaviorDependAppBar extends
    CoordinatorLayout.Behavior<View>
{
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, final View child,
                                   View dependency)
    {
        if (dependency instanceof AppBarLayout) {
            ((AppBarLayout) dependency).addOnOffsetChangedListener(new
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, View child,
                                         MotionEvent ev)
    {
        LogUtil.d(TAG, "onInterceptTouchEvent ev = " + ev.getAction() + " childe = " +
                  child);
        return false;
    }

    @Override
    public boolean onTouchEvent(CoordinatorLayout parent, View child,
                                MotionEvent ev)
    {
