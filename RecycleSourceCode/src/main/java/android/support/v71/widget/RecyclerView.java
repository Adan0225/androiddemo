           ...
           NestedScrollingChild
{
     ...
     */
    final android.support.v71.widget.ViewInfoStore mViewInfoStore = new
    android.support.v71.widget.ViewInfoStore();
    ...
    private final ArrayList<ItemDecoration> mItemDecorations = new
    ...
    private android.support.v71.widget.RecyclerViewAccessibilityDelegate
     ...
     * 回调 转化 view 的不同 动画
     */
    private final android.support.v71.widget.ViewInfoStore.ProcessCallback
                        ...
                        int defStyle)
    {
        ...
        setAccessibilityDelegateCompat(new
                                       android.support.v71.widget.RecyclerViewAccessibilityDelegate(this));
     ...
     */
    public android.support.v71.widget.RecyclerViewAccessibilityDelegate
    ...
    public void setAccessibilityDelegateCompat(
        android.support.v71.widget.RecyclerViewAccessibilityDelegate
     ...
     * 创建 LayotManager
     */
    private void createLayoutManager(Context context, String className,
                                     AttributeSet attrs,
                                     int defStyleAttr, int defStyleRes)
    {
        if (className != null) {
            ...
            if (className.length() !=
                0) {  // Can't use isEmpty since it was added in API 9.
    ...
    {
        mChildHelper = new android.support.v71.widget.ChildHelper(
        new android.support.v71.widget.ChildHelper.Callback() {
            @Override
     ...
     */
    public void addOnChildAttachStateChangeListener(OnChildAttachStateChangeListener
            listener)
    {
        if (mOnChildAttachStateListeners == null) {
            mOnChildAttachStateListeners = new
            ArrayList<OnChildAttachStateChangeListener>();
        }
     ...
     *                                  system.
     */
    public void setChildDrawingOrderCallback(ChildDrawingOrderCallback
    ...
    private void consumePendingUpdateOperations()
    {
        ...
        if (mAdapterHelper.hasAnyUpdateTypes(AdapterHelper.UpdateOp.UPDATE) &&
            !mAdapterHelper
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev)
    {
        ...
        if (dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY,
                                 mScrollOffset)) {
    ...
    {
        return mLayout.canScrollHorizontally() ? mLayout.computeHorizontalScrollOffset(
                   mState)
               : 0;
    }
    ...
    {
        return mLayout.canScrollHorizontally() ? mLayout.computeHorizontalScrollRange(
                   mState) : 0;
    }
    ...
    {
        return mLayout.canScrollVertically() ? mLayout.computeVerticalScrollExtent(
                   mState) : 0;
    }
    ...
    {
        return mLayout.canScrollVertically() ? mLayout.computeVerticalScrollRange(
                   mState) : 0;
    }
    ...
    public boolean fling(int velocityX, int velocityY)
    {
        ...
        if (!dispatchNestedPreFling(velocityX, velocityY)) {
            ...
            if (canScroll) {
                velocityX = Math.max(-mMaxFlingVelocity, Math.min(velocityX,
                                     mMaxFlingVelocity));
                velocityY = Math.max(-mMaxFlingVelocity, Math.min(velocityY,
                                     mMaxFlingVelocity));
    ...
    {
        if (mLayout == null ||
            !mLayout.onAddFocusables(this, views, direction, focusableMode)) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent e)
    {
        ...
        case MotionEventCompat.ACTION_POINTER_DOWN:
            ...
            mInitialTouchX = mLastTouchX = (int)(MotionEventCompat.getX(e,
                                                 actionIndex) + 0.5f);
            mInitialTouchY = mLastTouchY = (int)(MotionEventCompat.getY(e,
                                                 actionIndex) + 0.5f);
            break;
    ...
    public boolean onGenericMotionEvent(MotionEvent event)
    {
        ...
        if ((MotionEventCompat.getSource(event) &
             InputDeviceCompat.SOURCE_CLASS_POINTER) != 0) {
    ...
    {
        LogUtil.d(TAG, "onMeasure 开始测量 mAdapterUpdateDuringMeasure = " +
        ...
        if (mState.mRunPredictiveAnimations) {
            ...
            for (int i = 0; i < mChildHelper.getChildCount(); ++i) {
                ...
                if (!mViewInfoStore.isInPreLayout(viewHolder)) {
                    ...
                    // 判断 是否 隐藏
                    boolean wasHidden = viewHolder.hasAnyOfTheFlags(
     ...
     * @return
     */
    private boolean didChildRangeChange(int minPositionPreLayout,
                                   ...
                                   @Nullable ItemHolderInfo preLayoutInfo, @NonNull ItemHolderInfo postLayoutInfo)
    {
        ...
        if (mItemAnimator.animateAppearance(itemHolder, preLayoutInfo,
                                            postLayoutInfo)) {
            postAnimationRunner();
        }
    }
     ...
     * @param postInfo
     */
    private void animateChange(@NonNull ViewHolder oldHolder,
    ...
    void saveOldPositions()
    {
        ...
        for (int i = 0; i < childCount; i++) {
            final ViewHolder holder = getChildViewHolderInt(
                                          mChildHelper.getUnfilteredChildAt(i));
    ...
    private boolean canReuseUpdatedViewHolder(ViewHolder viewHolder)
    {
        return mItemAnimator == null ||
               mItemAnimator.canReuseUpdatedViewHolder(viewHolder);
    }
        ...
        public void run()
        {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                final boolean fullyConsumedVertical = dy != 0 && mLayout.canScrollVertically()
                                                      && vresult == dy;
                final boolean fullyConsumedHorizontal = dx != 0 &&
    ...
    public final class Recycler
    {
        ...
        public void setViewCacheSize(int viewCount)
        {
            ...
            for (int i = mCachedViews.size() - 1; i >= 0 &&
                 mCachedViews.size() > viewCount; i--) {
        ...
        // 递归 让ziView 不显示
        private void invalidateDisplayListInt(ViewGroup viewGroup,
        ...
        void recycleViewHolderInternal(ViewHolder holder)
        {
            ...
            // 判断是否是 过度状态  防止被回收
            final boolean transientStatePreventsRecycling =
    ...
    public abstract static class ViewCacheExtension
    {
         ...
         */
        abstract public View getViewForPositionAndType(Recycler recycler, int position,
                int type);
    }
    ...
    public static abstract class LayoutManager
    {
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (DISPATCH_TEMP_DETACH) {
                    ViewCompat.dispatchFinishTemporaryDetach(child);
                       ...
                       mRecyclerView) { // it was not a scrap but a valid child
        ...
        public void ignoreView(View view)
        {
            if (view.getParent() != mRecyclerView ||
                mRecyclerView.indexOfChild(view) == -1) {
         ...
         */
        public void layoutDecorated(View child, int left, int top, int right,
                                    int bottom)
        {
            final Rect insets = ((LayoutParams) child.getLayoutParams()).mDecorInsets;
        ...
        {
            onInitializeAccessibilityEvent(mRecyclerView.mRecycler, mRecyclerView.mState,
                                           event);
        }
        ...
        {
            return performAccessibilityActionForItem(mRecyclerView.mRecycler,
         ...
         * @see View#performAccessibilityAction(int, android.os.Bundle)
         */
        public boolean performAccessibilityActionForItem(Recycler recycler, State state,
                View view,
                                               ...
                                               int defStyleAttr, int defStyleRes)
        {
            ...
            properties.reverseLayout = a.getBoolean(R.styleable.RecyclerView_reverseLayout,
                                                    false);
            properties.stackFromEnd = a.getBoolean(R.styleable.RecyclerView_stackFromEnd,
                                                   false);
            a.recycle();
            return properties;
        }
     ...
     */
    public static class SimpleOnItemTouchListener implements
    ...
    public static abstract class ViewHolder
    {
         ...
         */
        void flagRemovedAndOffsetPosition(int mNewPosition, int offset,
                                          boolean applyToPreLayout)
        {
        ...
        public final void setIsRecyclable(boolean recyclable)
        {
            ...
            mIsRecyclableCount = recyclable ? mIsRecyclableCount - 1 : mIsRecyclableCount +
                                 1;
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed,
                                           int[] offsetInWindow)
    {
        return mScrollingChildHelper.dispatchNestedPreScroll(dx, dy, consumed,
                offsetInWindow);
    }
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY,
                                       boolean consumed)
    {
        return mScrollingChildHelper.dispatchNestedFling(velocityX, velocityY,
                consumed);
    }
    ...
    public static abstract class SmoothScroller
    {
        ...
        {
            final double magnitute = Math.sqrt(scrollVector.x * scrollVector.x +
                                               scrollVector.y *
                                               scrollVector.y);
         ...
         *               update this object.
         */
        abstract protected void onSeekTargetStep(int dx, int dy, State state,
                Action action);
         ...
         */
        abstract protected void onTargetFound(View targetView, State state,
                                              Action action);
     ...
     */
    private class ItemAnimatorRestoreListener implements
    ...
    public static abstract class ItemAnimator
    {
        ...
        {
            int flags = viewHolder.mFlags & (FLAG_INVALIDATED | FLAG_REMOVED |
                                             FLAG_CHANGED);
